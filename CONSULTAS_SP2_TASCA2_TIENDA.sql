...
select nombre, precio as EUR, precio * 1.02 as USD from producto;
...
select producto.nombre, precio, fabricante.nombre as 'nombre_fabricante' from producto inner join fabricante on producto.codigo_fabricante = fabricante.codigo;
/*22. Retorna una llista amb el nom del producte, preu i nom de fabricant de tots els productes de la base de dades. Ordena el resultat pel nom del fabricant, per ordre alfabètic.*/
select producto.nombre, precio, fabricante.nombre as 'nombre_fabricante' from producto inner join fabricante on producto.codigo_fabricante = fabricante.codigo order by fabricante.nombre asc;
...
select producto.nombre, precio, fabricante.nombre as 'nombre_fabricante' from producto inner join fabricante on producto.codigo_fabricante = fabricante.codigo where fabricante.nombre = 'Lenovo';
/*27. Retorna una llista de tots els productes del fabricant Crucial que tinguin un preu major que 200 €.*/
select producto.nombre, precio, fabricante.nombre as 'nombre_fabricante' from producto inner join fabricante on producto.codigo_fabricante = fabricante.codigo where fabricante.nombre = 'Crucial' and precio > 200;
/*28. Retorna un llistat amb tots els productes dels fabricants Asus, Hewlett-Packardy Seagate. Sense utilitzar l'operador IN.*/
select producto.nombre, precio, fabricante.nombre as 'nombre_fabricante' from producto inner join fabricante on producto.codigo_fabricante = fabricante.codigo where fabricante.nombre = 'Asus' or fabricante.nombre = 'Hewlett-Packard' or fabricante.nombre = 'Seagate';
/*29. Retorna un llistat amb tots els productes dels fabricants Asus, Hewlett-Packardy Seagate. Fent servir l'operador IN.*/
select producto.nombre, precio, fabricante.nombre as 'nombre_fabricante' from producto inner join fabricante on producto.codigo_fabricante = fabricante.codigo where fabricante.nombre in ('Asus','Hewlett-Packard','Seagate');
/*30. Retorna un llistat amb el nom i el preu de tots els productes dels fabricants el nom dels quals acabi per la vocal e.*/
select producto.nombre, precio, fabricante.nombre as 'nombre_fabricante' from producto inner join fabricante on producto.codigo_fabricante = fabricante.codigo where fabricante.nombre like '%e';
/*31. Retorna un llistat amb el nom i el preu de tots els productes el nom de fabricant dels quals contingui el caràcter w en el seu nom.*/
select producto.nombre, precio, fabricante.nombre as 'nombre_fabricante' from producto inner join fabricante on producto.codigo_fabricante = fabricante.codigo where fabricante.nombre like '%w%';
/*32. Retorna un llistat amb el nom de producte, preu i nom de fabricant, de tots els productes que tinguin un preu major o igual a 180 €. Ordena el resultat, en primer lloc, pel preu (en ordre descendent) i, en segon lloc, pel nom (en ordre ascendent).*/
select producto.nombre, precio, fabricante.nombre as 'nombre_fabricante' from producto inner join fabricante on producto.codigo_fabricante = fabricante.codigo where precio >= 180 order by precio desc, nombre asc;
...
select fabricante.codigo, fabricante.nombre as 'nombre_fabricante', producto.nombre as 'nombre_producto' from fabricante left join producto on fabricante.codigo = producto.codigo_fabricante;
